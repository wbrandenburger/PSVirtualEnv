@{
#
# Module manifest for module "PSModuleUtils"
#
...
Description = " The module PSModuleUtils is a set of powershell extensions to establish similar function for output, prompt, creation of project folders across powershell modules."
...
FunctionsToExport = @(
    ...
    "Get-ConfigHome",
    "New-ConfigHome",
    "Get-ConfigProjectDirList",
    "Get-ConfigProjectDir",
    "Get-ConfigProjectFile",
    "New-ConfigProjectDir",
